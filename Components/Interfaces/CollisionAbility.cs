...
public class CollisionAbility : MonoBehaviour, IConvertGameObjectToEntity, IAbility
{
    ...
    [HideInInspector] public List<Collider> Ñollisions;
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        switch (Collider)
        {
            ...
            case CapsuleCollider capsule:
                capsule.ToWorldSpaseCapsule(out var capsuleStart, out var capsuleEnd, out var capsuleRadius);
                dstManager.AddComponentData(entity, new ActorColliderData
                {
